...
This bot just makes the gamestop thing say boyhole instead of buy hold. This bot automatically fetches [orders](https://github.com/Bones-01/BoyholeBot/orders.json) every few minutes, to prevent bots from working against each other.
...
2. Click on this link: [https://github.com/bones-01/BoyholeBot/raw/master/placenlbot.user.js](https://github.com/bones-01/BoyholeBot/raw/master/placenlbot.user.js). If all goes well, Tampermonkey should offer you to install a userscript. Click on **Install**.
